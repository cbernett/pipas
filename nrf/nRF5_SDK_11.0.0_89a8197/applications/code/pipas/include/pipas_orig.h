...
#define ENABLE_CALCULATED_LOG 1
#define ENABLE_ACCEL_LOG      1
#define ENABLE_GYRO_LOG       1
#define ENABLE_MAG_LOG        1
#define ENABLE_QUAT_LOG       1
#define ENABLE_EULER_LOG      11
#define ENABLE_HEADING_LOG    1
...
// LED Config //
////////////////
#define HW_LED_PIN 29        // LED attached to pin 13
...
#define ENABLE_GYRO_CALIBRATION 1

///////////////////////
// SD Logging Config //
///////////////////////
#define ENABLE_SD_LOGGING 1 // Default SD logging (can be changed via serial menu)
#define LOG_FILE_INDEX_MAX 999 // Max number of "pipasXXX.txt" files
#define LOG_FILE_PREFIX "pipas"  // Prefix name for log files
